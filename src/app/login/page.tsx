    ...
    <div className="flex min-h-[80vh] items-center justify-center px-4 animate-fade-in">
      <Card className="w-full max-w-sm border-border/40 shadow-2xl shadow-black/20">
        <CardHeader className="text-center pb-2">
          <div className="mx-auto mb-3 flex h-12 w-12 items-center justify-center rounded-xl bg-gold/10 border border-gold/20">
            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="rgb(212, 175, 55)" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
